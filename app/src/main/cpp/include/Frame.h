...
public:
    ...
    virtual // Compute Bag of Words representation.
    void ComputeBoW();

    // Set the camera pose. (Imu pose is not modified!)
    void SetPose(const Sophus::SE3<float> &Tcw);

    virtual // Set IMU velocity
    ...
    virtual Eigen::Vector3f GetRelativePoseTlr_translation();
...
public:
    ...
    //Matching data frame id
    long unsigned int mnIdMatchingData;
