...
public:
    ...
    FrameAHB GrabImageStereoAHB(AHardwareBuffer* imagesBuffer, const double &timestamp, string filename);
    Sophus::SE3f GrabImageStereoAHBFinish(FrameAHB frameAHB);
