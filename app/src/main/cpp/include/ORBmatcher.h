...
namespace ORB_SLAM3
{
    ...
    private:
        int SearchByProjectionThread(Frame &CurrentFrame, const Frame &LastFrame, const float th, const bool bMono, int threadId, int nThreads, std::vector<int>* rotHist, std::mutex& rotHistMutex);
