...
void KeyFrame::UpdateConnections(bool upParent)
{
    ...
    sort(vPairs.begin(),vPairs.end(), [](const pair<int,KeyFrame*>& lh, const pair<int,KeyFrame*>& rh){return (lh.first < rh.first && lh.second->mnId < rh.second->mnId);});    list<KeyFrame*> lKFs;
    list<int> lWs;
